...
public class Main2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2);miActivity = this;
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    ...
                    Toast.makeText(Main2Activity.this, "esta logueado", Toast.LENGTH_SHORT).show();
            ...
            mAuth.createUserWithEmailAndPassword(correoNuevo,contrasenaNuevo).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(Main2Activity.this, "no se pudo crear el Usuario", Toast.LENGTH_SHORT).show();
    ...
    private void signIn(){
        ...
        if(!checkFields()){
            ...
            mAuth.signInWithEmailAndPassword(correo,contrasena).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        Toast.makeText(Main2Activity.this, "Sign in", Toast.LENGTH_SHORT).show();
                    }else{
